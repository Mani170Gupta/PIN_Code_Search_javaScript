async function func() {
    var x = document.getElementById('branch-search').value;

    let url = `https://api.postalpincode.in/postoffice/${x}`;
    ...
    console.log(val)
            ...
            if (val[0].PostOffice||val[0]||val[0].PostOffice.length===0) {
                ...
                let table = '<table border="2"> <thead><tr><th>Name</th><th>Branch Type</th><th>Delivery Status</th><th>Circle</th><th>District</th><th>Division</th><th>Region</th><th>State</th><th>Country</th><th>Pincode</th></tr></thead><tbody>';
